...
if (typeof BX.Salesbeat.CatalogElementDelivery === 'undefined') {
    BX.Salesbeat.CatalogElementDelivery = {
        init: function (params) {
            ...
            this.buttonPlus = document.querySelector('.counter_block .plus');
            this.buttonMinus = document.querySelector('.counter_block .minus');
            this.input = document.querySelector('.counter_block input');
